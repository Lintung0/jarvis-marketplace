    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="space-y-6 text-sm text-gray-400 leading-relaxed">
        {[
          ...
          { title: "5. Hak Pengguna", content: "Kamu berhak mengakses, mengubah, atau menghapus data pribadi kamu. Hubungi kami di support@jarvis-marketplace.com untuk permintaan terkait data." },
        ].map((section) => (
