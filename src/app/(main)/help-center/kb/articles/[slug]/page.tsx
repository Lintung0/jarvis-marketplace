  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500 mb-6 flex-wrap">
        ...
        <ChevronRight className="w-3 h-3 shrink-0" />
        <Link href={`/help-center/kb/${article.category?.slug}`} className="hover:text-teal-600 transition">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 sticky top-24">
                ...
                {related.map((r: any) => (
                  <li key={r.id}>
                    <Link
                      ...
                      className="text-sm text-gray-600 hover:text-teal-600 transition line-clamp-2"
                    >
                      {r.title}
                    </Link>
                  </li>
            ...
            <div className="mt-6 pt-4 border-t border-gray-100">
              ...
              <Link
                ...
                className="inline-block w-full text-center px-4 py-2 text-sm font-medium rounded-xl gradient-brand text-white hover:shadow-lg hover:shadow-teal-500/25 transition"
              >
                Buat Tiket Support
              </Link>
            </div>
