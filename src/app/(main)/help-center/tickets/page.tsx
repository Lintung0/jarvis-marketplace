    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium rounded-xl gradient-brand text-white hover:shadow-lg hover:shadow-orange-500/25 transition"
        >
      ...
      {tickets.length === 0 ? (
        <div className="text-center py-16 bg-white border border-gray-200 rounded-2xl">
          ...
          <Link
            href="/help-center/tickets/new"
            className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-xl gradient-brand text-white hover:shadow-lg hover:shadow-orange-500/25 transition"
          >
            <Plus className="w-4 h-4" />
            Buat Tiket
          </Link>
